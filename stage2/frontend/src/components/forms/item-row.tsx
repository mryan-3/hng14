...
export default function ItemRow({ item, index, onUpdate, onRemove }: ItemRowProps) {
  return (
    <div className="flex flex-col md:grid md:grid-cols-[2.5fr_0.8fr_1fr_0.7fr_auto] gap-4 items-center">
      <div className="w-full md:contents">
        <div className="w-full">
          ...
          <Input 
            ...
            className="md:py-[14px]" 
          />
        </div>

        <div className="grid grid-cols-[1fr_2.5fr_1.5fr_auto] gap-4 items-end w-full md:contents">
          <div>
          ...
          <div className="flex flex-col gap-5 md:gap-0">
            ...
            <div className="flex items-center h-[48px] md:h-[50px] font-bold text-[#7E88C3] dark:text-[#888EB0] text-xs md:text-sm">
          ...
          <button 
            ...
            className="flex items-center justify-center p-2 mb-3 md:mb-4 group cursor-pointer"
            aria-label="Delete item"
          >
            <svg width="13" height="16" xmlns="http://www.w3.org/2000/svg" className="fill-[#888EB0] hover:fill-error transition-colors">
