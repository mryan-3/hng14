...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed top-0 left-0 z-50 flex flex-row items-center justify-between w-full h-20 bg-sidebar-bg lg:flex-col lg:w-[103px] lg:h-full lg:rounded-r-[20px] transition-all duration-300">
      {/* Logo Section */}
      <Link href="/" className="relative flex items-center justify-center w-20 h-20 bg-primary-purple rounded-r-[20px] lg:w-[103px] lg:h-[103px] group overflow-hidden">
        {/* Bottom decorative shape */}
        <div className="absolute bottom-0 left-0 w-full h-1/2 bg-primary-purple-light rounded-tl-[20px] transition-all duration-300" />
        
        {/* Logo SVG */}
        <div className="relative z-10">
          <svg width="28" height="26" viewBox="0 0 28 26" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fillRule="evenodd" clipRule="evenodd" d="M14 0L28 26H0L14 0Z" fill="white"/>
            <path opacity="0.5" fillRule="evenodd" clipRule="evenodd" d="M14 13L21 26H7L14 13Z" fill="white"/>
          </svg>
        </div>
      </Link>
